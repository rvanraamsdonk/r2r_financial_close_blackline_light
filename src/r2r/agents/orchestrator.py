...
def node_orchestrate(state: CloseState, *, console: Console) -> CloseState:
    ...
    tasks = [
        ...
        Task(id="T-JE", stage="JOURNALS", owner="fin.preparer", sla=today+timedelta(days=3), predecessors=["T-RECS","T-MATCH"]),
        ...
        Task(id="T-COMP", stage="GOVERNANCE", owner="fin.controller", sla=today+timedelta(days=4), predecessors=["T-JE","T-FLUX","T-IC"]),
    ]
